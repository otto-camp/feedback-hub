...
export default function Footer() {
  return (
    <footer className="w-full border-t bg-background">
      <div className="container mx-auto p-4 flex flex-col items-center justify-between space-y-1 py-5 md:h-16 md:flex-row md:py-0">
        ...
        <div className="flex items-center space-x-1">
          <Link href="https://github.com/otto-camp" target="_blank" rel="noreferrer">
            <div
              className={cn(
                buttonVariants({
                  size: "icon",
